...
export function Sidebar() {
  ...
  const navItems = [
    ...
    { name: "Calendar", href: "/calendar", icon: CalendarDays, show: true },
    { name: "Trips", href: "/trips", icon: Map, show: true },
    { name: "Drivers", href: "/drivers", icon: Users, show: isAdmin },
    { name: "WhatsApp", href: "/whatsapp", icon: MessageCircle, show: isAdmin },
  ...
  return (
    <aside className="w-72 hidden md:flex flex-col border-r border-white/5 bg-card/40 backdrop-blur-2xl h-screen sticky top-0">
      <div className="p-6 flex items-center gap-3">
        ...
        <span className="font-display font-bold text-xl tracking-tight text-white">TransitOS</span>
      </div>
